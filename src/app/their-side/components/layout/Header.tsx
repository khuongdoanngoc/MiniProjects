...
import Poster from "../../assets/theirside_poster.jpeg";
import TextTruncate from "../TextTruncate";
function Header() {
    return (
        <header className="bg-slate-50 lg:w-[35%] md:w-[80%]  h-screen flex md:overflow-y-auto lg:overflow-y-auto">
            <div className="lg:[writing-mode:vertical-rl] hidden lg:w-16 border text-sm lg:leading-7 items-center lg:flex lg:whitespace-nowrap lg:py-12">
                <span className="font-mono text-slate-500">Hosted by</span>
                <span className="flex mt-6 gap-6 font-bold text-slate-900">
                    Doan Ngoc Khuong
            ...
            <div className="relative w-full flex h-full lg:min-h-full flex-col px-12 pt-12 md:py-12 items-center">
                <Image
                    src={Poster}
                    alt="poster"
                    className="shadow-xl shadow-slate-200 lg:rounded-2xl border"
                    width={318}
                    height={318}
                />
                <div className="mt-10 text-center lg:text-left lg:mt-12 lg:w-auto ">
                    <p className="font-bold text-slate-900 text-xl">
                        Their Side
                    </p>
                    <p className="mt-3 text-lg font-medium text-slate-700 leading-8">
                        Conversations with the most tragically misunderstood
                        people of our time.
                    </p>
                </div>
                <div className="mt-12 hidden md:flex md:flex-col lg:w-full">
                    <span className="flex items-center gap-2 lg:text-left text-sm font-medium text-slate-900">
                        <svg
                            aria-hidden="true"
                            viewBox="0 0 10 10"
                ...
                <div className="flex flex-col w-full mt-12">
                    <span className="flex items-center justify-center md:justify-start gap-2 lg:text-left text-sm font-medium text-slate-900 lg:w-full">
                        <svg
                            aria-hidden="true"
                            viewBox="0 0 10 10"
                            className="h-2.5 w-2.5">
                    ...
                    <div className="flex md:flex-col justify-center gap-6 md:justify-start lg:gap-4 mt-4 mb-12">
                        ...
                        <div className="flex gap-3 items-center">
                            ...
                            <span className="hidden md:block">Apple Podcast</span>
                        </div>
                        <div className="flex gap-3 items-center">
                            <svg
                                aria-hidden="true"
                            ...
                            <span className="hidden md:block">Overcast</span>
                        </div>
                        <div className="flex gap-3 items-center">
                            <svg
                                aria-hidden="true"
                                ...
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    d="M8.5 4h15A4.5 4.5 0 0 1 28 8.5v15a4.5 4.5 0 0 1-4.5 4.5h-15A4.5 4.5 0 0 1 4 23.5v-15A4.5 4.5 0 0 1 8.5 4ZM13 22a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm-6-6a9 9 0 0 1 9 9h3A12 12 0 0 0 7 13v3Zm5.74-4.858A15 15 0 0 0 7 10V7a18 18 0 0 1 18 18h-3a15 15 0 0 0-9.26-13.858Z"></path>
                            </svg>
