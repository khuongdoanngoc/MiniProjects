...
function Header() {
    return (
        <header className="bg-slate-50 lg:w-[35%] lg:h-screen flex lg:overflow-y-auto">
            <div className="lg:[writing-mode:vertical-rl] lg:w-16 flex border text-sm lg:leading-7 items-center lg:flex-none lg:whitespace-nowrap lg:py-12">
            ...
            <div className="relative flex w-full h-full lg:min-h-full flex-col px-12 py-12 items-center">
                <Image
                    src={Poster}
                    alt="poster"
                ...
                <div className="mt-12 flex-column lg:w-full">
                ...
                <div className="flex flex-col w-full mt-12">
                    <span className="flex items-center gap-2 lg:text-left text-sm font-medium text-slate-900 lg:w-full">
                        <svg
                            aria-hidden="true"
                            viewBox="0 0 10 10"
                            className="h-2.5 w-2.5">
                    ...
                    <div className="flex flex-col lg:gap-4 mt-4 mb-12">
